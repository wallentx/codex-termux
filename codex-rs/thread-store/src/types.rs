...
pub struct ThreadMetadataPatch {
    ...
    /// Recorded creator user. Only fills a missing stored value.
    pub creator_user_id: Option<String>,
    /// Recorded creator account. Only fills a missing stored value.
    pub creator_account_id: Option<String>,
...
impl ThreadMetadataPatch {
    ...
    pub fn merge(&mut self, next: Self) {
        ...
        if next.creator_user_id.is_some() {
            self.creator_user_id = next.creator_user_id;
        }
        if next.creator_account_id.is_some() {
            self.creator_account_id = next.creator_account_id;
        }
    ...
    pub fn is_empty(&self) -> bool {
        self.name.is_none()
            ...
            && self.creator_user_id.is_none()
            && self.creator_account_id.is_none()
